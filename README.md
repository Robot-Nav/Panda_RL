...
- 提交信息：使用中文或英文，清晰描述改动内容
- 如需添加新场景，请在 `model/franka_emika_panda/` 下创建对应的 XML 文件

---

## 引用

如果你在学术工作中使用了本项目，请按以下格式引用：

```bibtex
@software{mujoco_learning2026,
  author = {Your Name},
  title = {Franka Panda 机械臂强化学习: PPO + MuJoCo 目标到达与避障},
  year = {2026},
  url = {https://github.com/fatu08/mujoco-learning}
}
```
